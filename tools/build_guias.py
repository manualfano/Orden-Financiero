...
CSS = TOKENS + """
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .descarga { display: grid; grid-template-columns: minmax(0, 1.15fr) minmax(0, 1fr); gap: var(--s-6); align-items: center; background: var(--navy); color: var(--w); border-radius: var(--r-lg); padding: var(--s-6); margin: var(--s-7) 0; }
  @media (max-width: 860px) { .descarga { grid-template-columns: 1fr; gap: var(--s-5); padding: var(--s-5); } }
  ...
  article .descarga .descarga-linea { color: rgba(255,255,255,0.82); margin-bottom: var(--s-4); }
  .descarga-hoja { background: var(--w); border-radius: var(--r); overflow: hidden; font-size: var(--fs-meta); line-height: 1.4; font-variant-numeric: tabular-nums; box-shadow: 0 10px 28px rgba(0,0,0,0.28); color: var(--tinta); }
  ...
  .descarga-hoja .fila span { padding: 5px 8px; border-bottom: 1px solid #E1E1E1; border-left: 1px solid #E1E1E1; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: var(--tinta); }
  .descarga-hoja .fila span:nth-child(n+3) { text-align: right; }
  .descarga-hoja .fila span:first-child { border-left: 0; background: #F3F3F3; color: #777; text-align: center; padding: 5px 0; }
  .descarga-hoja .letras span { background: #F3F3F3; color: #777; text-align: center !important; padding: 3px 8px; }
  ...
  .descarga-hoja .pestanas { display: flex; padding: 0 6px; background: #F3F3F3; border-top: 1px solid #D6D6D6; overflow: hidden; }
  .descarga-hoja .pestanas span { padding: 5px 10px; color: #555; white-space: nowrap; border-right: 1px solid #DDD; }
  ...
  .descarga-form { background: var(--w); color: var(--tinta); border-radius: var(--r-lg); padding: var(--s-5); box-shadow: 0 12px 32px rgba(0,0,0,0.25); }
    ...
    return f"""<aside class="descarga" id="{uid}" aria-labelledby="{uid}-t" data-descarga="{e(clave)}" data-archivo="{e(d['archivo'])}" data-nombre="{e(d['nombre'])}" data-origen="guia-{e(slug)}-excel" data-evento="{e(d['evento'])}">
      ...
      <div class="descarga-form">
        <form class="descarga-campos" novalidate>
          <p class="form-t">Bajala gratis</p>
