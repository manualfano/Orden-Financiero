...
CSS = TOKENS + """
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .dot { color: var(--marca); }
  /* Barra igual a la de la home (16/09/2026, pedido del dueño): mismos links; en celular, menú de tres líneas */
  header { position: relative; z-index: 20; }
  .head-nav { display: flex; align-items: center; gap: var(--s-2); }
  ...
  .head-nav .head-link { padding: 0 var(--s-3); border-radius: var(--r); color: rgba(255,255,255,0.92); }
  .head-nav .head-link:hover { color: var(--w); background: rgba(255,255,255,0.10); }
  .head-nav .head-link[aria-current] { color: var(--w); background: rgba(255,255,255,0.10); }
  .head-nav .head-cta { background: var(--marca); padding: 0 var(--s-4); border-radius: var(--r); font-weight: 600; margin-left: var(--s-2); }
  ...
  @media (max-width: 1023px) {
    ...
    .head-burger:hover { background: rgba(255,255,255,0.10); }
    ...
    .head-menu { position: absolute; top: 100%; left: 0; right: 0; display: flex; flex-direction: column; padding: var(--s-2) var(--s-4) var(--s-4); background: var(--navy-900); border-top: 1px solid rgba(255,255,255,0.10); box-shadow: 0 12px 24px rgba(0,0,0,0.25); }
    ...
    .head-menu a:hover, .head-menu a[aria-current] { color: var(--w); background: rgba(255,255,255,0.10); }
  }
  @media (max-width: 420px) {
    .head-in { flex-wrap: nowrap; gap: var(--s-2); }
    .brand { font-size: var(--fs-base); }
    .head-nav .head-cta { padding: 0 var(--s-3); margin-left: 0; font-size: 13px; }
  }
...
<header>
  <div class="head-in">
    ...
    <nav class="head-nav" aria-label="Principal">
      <a class="head-link" href="/#que-analizamos">El diagnóstico</a>
      <a class="head-link" href="/#metodo">El programa</a>
      <a class="head-link" href="/#manuel">Quién está detrás</a>
      <a class="head-link" href="/guias"{guias_actual}>Guías</a>
...
(function () {{
  ...
  window.addEventListener('resize', function () {{ if (window.innerWidth > 1023) cerrar(); }});
